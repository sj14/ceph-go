...
func createUserFixture(t *testing.T, client *mgr.Client, ctx context.Context) (*userFixture, mgr.User) {
	t.Helper()
	...
	t.Cleanup(func() {
		...
		defer cleanupCancel()
		if err := fixture.client.DeleteUser(cleanupCtx, mgr.DeleteUserRequest{UID: fixture.uid}); err != nil {
...
func TestGetUser(t *testing.T) {
	...
	user, err = client.GetUser(ctx, mgr.GetUserRequest{UID: fixture.uid, Stats: new(false)})
	if err != nil {
		t.Fatal(err)
	}
	if user.Stats != nil {
...
func TestListUsers(t *testing.T) {
	...
	users, err := client.ListUsers(ctx, mgr.ListUsersRequest{})
	if err != nil {
		t.Fatal(err)
	}
...
func TestUpdateUser(t *testing.T) {
	...
	user, err := client.UpdateUser(ctx, mgr.UpdateUserRequest{
		UID:         fixture.uid,
...
func TestDeleteUser(t *testing.T) {
	...
	if err := client.DeleteUser(ctx, mgr.DeleteUserRequest{UID: fixture.uid}); err != nil {
		t.Fatal(err)
	}
	fixture.deleted = true

	_, err := client.GetUser(ctx, mgr.GetUserRequest{UID: fixture.uid})
