...
func (client *Client) GetMetadataLogInfo(ctx context.Context) (MetadataLogInfo, error) {
	if ctx == nil {
		return MetadataLogInfo{}, errors.New("admin: context must not be nil")
	}
...
func (client *Client) GetMetadataLogShardInfo(ctx context.Context, input GetMetadataLogShardInfoRequest) (MetadataLogShardInfo, error) {
	if ctx == nil {
		return MetadataLogShardInfo{}, errors.New("admin: context must not be nil")
	}
	if input.ShardID < 0 {
		return MetadataLogShardInfo{}, errors.New("admin: metadata log shard ID must not be negative")
	}
...
func (client *Client) ListMetadataLogEntries(ctx context.Context, input ListMetadataLogEntriesRequest) (MetadataLogEntryList, error) {
	if ctx == nil {
		return MetadataLogEntryList{}, errors.New("admin: context must not be nil")
	}
	if input.ShardID < 0 {
		return MetadataLogEntryList{}, errors.New("admin: metadata log shard ID must not be negative")
	}
...
func (client *Client) GetMetadataLogStatus(ctx context.Context) (MetadataLogSyncStatus, error) {
	if ctx == nil {
		return MetadataLogSyncStatus{}, errors.New("admin: context must not be nil")
	}
