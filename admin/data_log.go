...
func (client *Client) GetDataLogInfo(ctx context.Context) (DataLogInfo, error) {
	if ctx == nil {
		return DataLogInfo{}, errors.New("admin: context must not be nil")
	}
...
func (client *Client) GetDataLogShardInfo(ctx context.Context, input GetDataLogShardInfoRequest) (DataLogShardInfo, error) {
	if ctx == nil {
		return DataLogShardInfo{}, errors.New("admin: context must not be nil")
	}
	if input.ShardID < 0 {
		return DataLogShardInfo{}, errors.New("admin: data log shard ID must not be negative")
	}
...
func (client *Client) ListDataLogEntries(ctx context.Context, input ListDataLogEntriesRequest) (DataLogEntryList, error) {
	if ctx == nil {
		return DataLogEntryList{}, errors.New("admin: context must not be nil")
	}
	if input.ShardID < 0 {
		return DataLogEntryList{}, errors.New("admin: data log shard ID must not be negative")
	}
...
func (client *Client) GetDataLogStatus(ctx context.Context, input GetDataLogStatusRequest) (DataLogSyncStatus, error) {
	if ctx == nil {
		return DataLogSyncStatus{}, errors.New("admin: context must not be nil")
	}
